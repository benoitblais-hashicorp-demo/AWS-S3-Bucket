...
* **aws_s3_bucket_policy** - Bucket policy to enforce SSL/TLS (conditional)
* **aws_cloudtrail** - CloudTrail trail for S3 data event logging (optional, enabled by default)
